...
namespace AdoptAnimal.Data.Migrations
{
    ...
    [Migration("20220313163012_AddDbSetOfSubCategory")]
    partial class AddDbSetOfSubCategory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdoptAnimal.Data.Models.Add", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AdoptAnimal.Data.Models.Comment", b =>
                {
                    b.HasOne("AdoptAnimal.Data.Models.Add", "Add")
                        .WithMany("Comments")
                        .HasForeignKey("AddId")
            ...
            modelBuilder.Entity("AdoptAnimal.Data.Models.Pet", b =>
                {
                    b.HasOne("AdoptAnimal.Data.Models.Add", "Add")
                        .WithOne("Pet")
                        .HasForeignKey("AdoptAnimal.Data.Models.Pet", "AddForeignKey")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
